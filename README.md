...
Сайт работает на моем домашнем сервере по [адресу](http://95.78.238.68:2021) (На момент чтения вами этой документации
он, скорее всего, стоит, однако просто запустив файл __main.py__ приложение будет работать локально)
